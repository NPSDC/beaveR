test_that("aggAssays", {
    ...
    expect_equal(SummarizedExperiment::assays(seAgg)[["infRep10"]][l+1,],
                 colSums(SummarizedExperiment::assays(seAgg)[["infRep10"]][1:l,]))
    expect_equal(SummarizedExperiment::assays(seAgg)[["infRep1"]][l+1,],
                 colSums(SummarizedExperiment::assays(seAgg)[["infRep1"]][1:l,]))
    expect_equal(SummarizedExperiment::assays(seAgg)[["counts"]][l+2,],
                 colSums(SummarizedExperiment::assays(seAgg)[["counts"]][phangorn::Descendants(tree,l+2)[[1]],]))
